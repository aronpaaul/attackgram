...
final class PasscodeEntryControllerNode: ASDisplayNode {
    ...
    func initialAppearance(fadeIn: Bool = false) {
        ...
        self.titleNode.setAttributedText(NSAttributedString(string: self.strings.EnterPasscode_EnterPasscode.replacingOccurrences(of: "Telegram", with: "AttackGram") /* MARK: Swiftgram */, font: titleFont, textColor: .white), animation: .none)
    }
    ...
    func animateIn(iconFrame: CGRect, completion: @escaping () -> Void = {}) {
        ...
        self.titleNode.setAttributedText(NSAttributedString(string: self.strings.Passcode_AppLockedAlert.replacingOccurrences(of: "\n", with: " "), font: titleFont, textColor: .white), animation: .slideIn, completion: {
            ...
            Queue.mainQueue().after(1.5, {
                self.titleNode.setAttributedText(NSAttributedString(string: self.strings.EnterPasscode_EnterPasscode.replacingOccurrences(of: "Telegram", with: "AttackGram") /* MARK: Swiftgram */, font: titleFont, textColor: .white), animation: .crossFade)
                if let validLayout = self.validLayout {
