...
public func sgProController(context: AccountContext) -> ViewController {
    ...
    |> map { presentationData, _ ->  (ItemListControllerState, (ItemListNodeState, Any)) in
        ...
        let controllerState = ItemListControllerState(presentationData: ItemListPresentationData(presentationData), title: .text("AttackGram Pro"), leftNavigationButton: nil, rightNavigationButton: nil, backNavigationButton: ItemListBackButton(title: presentationData.strings.Common_Back))
